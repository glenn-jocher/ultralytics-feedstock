...
def setup_environment(ns):
    """Set environment variables for build configuration based on namespace arguments."""
...
def run_docker_build(ns):
    """Executes the Docker build process using a specified shell script for environment setup and package management."""
    script = ".scripts/run_docker_build.sh"
    subprocess.check_call([script])


def run_osx_build(ns):
    """Executes the macOS build script for the Ultralytics package using specified environment settings."""
    script = ".scripts/run_osx_build.sh"
    subprocess.check_call([script])


def verify_config(ns):
    """Verifies and selects a valid configuration from available YAML files for build compatibility."""
    valid_configs = {
...
def main(args=None):
    """Executes the build process locally by setting up the environment and running platform-specific build scripts."""
